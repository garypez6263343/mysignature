        ...
        <tr>
          ...
          <td style={{ verticalAlign: 'top' }}>
            ...
            <span style={{ display: 'block', marginTop: 8 }}>
              <a href={`mailto:${email}`} style={{ color: '#ffc107', textDecoration: 'none' }}>{email}</a>
              {phone && (
                <>
                  {' · '}
                  <a href={`tel:${phone.replace(/\s/g, '')}`} style={{ color: '#ffc107', textDecoration: 'none' }}>{phone}</a>
                </>
              )}
              <br />
              <a href={website} target="_blank" rel="noopener noreferrer" style={{ color: '#ffc107', textDecoration: 'none' }}>
